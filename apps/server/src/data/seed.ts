...
export const content = [
  ...
  },
  {
    ...
    technologies: ['Python 3', 'Bytecode VM', 'Stack Machine', 'AST Parser', 'Disassembler', 'Next.js'],
    tags: ['Virtual Machine', 'Compiler', 'Systems Programming', 'Python', 'Bytecode', 'Visualizer'],
    metrics: [
      { label: 'Architecture', value: 'Stack-Based VM' },
      { label: 'Safety', value: 'Zero eval/exec' },
      { label: 'Opcodes', value: '18+ Instructions' }
    ],
    links: [
      { label: 'Live Interactive Demo', url: 'https://bytecode-virtual-machine-git-main-choyon-dhors-projects.vercel.app/' },
      { label: 'GitHub Repository', url: 'https://github.com/Choyon-Dhor/Bytecode-Virtual-Machine' }
    ],
    metadata: {
  ...
  },
  {
    ...
    technologies: ['C', 'Flex', 'Bison (LALR)', 'AST', 'Three-Address Code', 'Linux / Ubuntu', 'Makefile'],
    tags: ['Compiler Construction', 'Flex & Bison', 'C', 'Three-Address Code', 'Systems Programming', 'Team Lead'],
    metrics: [
      { label: 'Role', value: 'Team Lead' },
      { label: 'Pipeline', value: 'Lexer > Parser > AST > TAC' },
      { label: 'Environment', value: 'Ubuntu Linux' }
    ],
    links: [
      { label: 'GitHub Repository', url: 'https://github.com/TeamBytebuilders/CC-Lab-Project-Team-Bytebuilders' },
      { label: 'Team Lead Mirror', url: 'https://github.com/Choyon-Dhor/CC-Lab-Project-Team-Bytebuilders' }
    ],
    metadata: {
  ...
  },
  {
    ...
    technologies: ['PyTorch', 'CNN', 'Gradio', 'Hugging Face Spaces', 'Torchvision', 'Scikit-Learn', 'Matplotlib'],
    tags: ['Deep Learning', 'CNN', 'Computer Vision', 'PyTorch', 'Hugging Face', 'Interactive AI'],
    metrics: [
      { label: 'Test Accuracy', value: '99.06% (MNIST)' },
      { label: 'Framework', value: 'PyTorch + Gradio' },
      { label: 'Deployment', value: 'Hugging Face Spaces' }
    ],
    links: [
      { label: 'Live Hugging Face Space', url: 'https://huggingface.co/spaces/ChoyonDhor/hand-written-digit-recognition' },
      { label: 'GitHub Repository', url: 'https://github.com/Choyon-Dhor/handwritten-digit-recognition-cnn' }
    ],
    metadata: {
  ...
  },
  {
    ...
    technologies: ['React.js', 'Node.js', 'Express', 'PostgreSQL', 'Tailwind CSS', 'Netlify'],
    tags: ['Full-Stack', 'Web Application', 'Campus System', 'React', 'PostgreSQL', 'Education'],
    metrics: [
      { label: 'Target Userbase', value: 'University Students' },
      { label: 'Architecture', value: 'React + Node + DB' },
      { label: 'Live Host', value: 'Netlify' }
    ],
    links: [
      { label: 'Live Web Portal', url: 'https://effortless-khapse-9143fb.netlify.app/login' },
      { label: 'GitHub Repository', url: 'https://github.com/Choyon-Dhor/Campusassit' }
    ],
    metadata: {
  ...
  { type: 'education', slug: 'bsc-cse-metropolitan-university', title: 'B.Sc. in Computer Science and Engineering', eyebrow: 'ACADEMIC CORE', summary: 'Final-year undergraduate with interests in AI, machine learning and energy informatics.', category: 'Degree', organization: 'Metropolitan University, Bangladesh', location: 'Sylhet, Bangladesh', status: 'In Progress', order: 1, metrics: [{ label: 'CGPA', value: '3.99/4.00' }, { label: 'Expected graduation', value: '2026-2027' }] },
  {
    ...
    order: 1,
    technologies: ['Flex', 'Bison', 'C', 'C++', 'Three-Address Code', 'Linux / Ubuntu', 'Makefile'],
    metrics: [{ label: 'Pipeline', value: 'Lexer > Parser > AST > TAC' }, { label: 'Environment', value: 'Ubuntu Linux' }]
  },
  {
    type: 'skill',
    ...
    order: 2,
    technologies: ['Python 3', 'Bytecode VM', 'Stack Machine', 'Recursive Descent', 'Disassembler', 'Opcode Design'],
    metrics: [{ label: 'Architecture', value: 'Stack-Based VM' }, { label: 'Safety', value: 'Zero eval/exec' }]
  },
  {
    type: 'skill',
    ...
    order: 3,
    technologies: ['PyTorch', 'CNN', 'Torchvision', 'Gradio', 'Hugging Face Spaces', 'NumPy', 'Scikit-Learn'],
    metrics: [{ label: 'Accuracy', value: '99.06% on MNIST' }, { label: 'Deployment', value: 'Hugging Face Spaces' }]
  },
  {
    type: 'skill',
    slug: 'full-stack-web',
    ...
    order: 4,
    technologies: ['React.js', 'Node.js', 'Express', 'PostgreSQL', 'MongoDB', 'REST APIs', 'Tailwind CSS'],
    metrics: [{ label: 'Architecture', value: '3-Tier Web' }, { label: 'Cloud Hosts', value: 'Netlify & Vercel' }]
  },
  {
    type: 'skill',
    ...
    order: 5,
    technologies: ['Scikit-learn', 'XGBoost', 'LightGBM', 'CatBoost', 'Pandas', 'NumPy'],
    metrics: [{ label: 'Focus', value: 'Time-Series AI' }, { label: 'Validation', value: 'Chronological CV' }]
  },
  {
    type: 'skill',
    slug: 'programming',
    ...
    order: 6,
    technologies: ['C', 'C++', 'Python', 'Java', 'SQL', 'Git'],
    metrics: [{ label: 'CGPA', value: '3.99/4.00' }, { label: 'Foundation', value: 'Data Structures & Algos' }]
  },
  {
    type: 'blog',
    ...
    tags: ['Time Series', 'Context-Aware AI', 'Energy']
  },
  {
    type: 'blog',
...
export async function ensureInitialData(): Promise<void> {
  ...
  if (await SiteSettings.countDocuments() === 0) { await SiteSettings.create(initialSiteSettings); } else { await SiteSettings.updateOne({ key: 'primary' }, { $set: { seoTitle: 'Choyon Dhor' } }); }
